...
| `Anexo_G_script_reproducible.py` | Script reproducible (vía `scripts/common/config.py`) que regenera ambas figuras a partir de `resultados/profiling_aqp_motifs_final/PCA_Coordenadas_Finales.csv`. |
