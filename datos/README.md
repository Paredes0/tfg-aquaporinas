...
> Los **datos primarios** (genoma 'Benihoppe' FASTA/GFF3, 22 muestras RNA-seq paired-end) **no** se incluyen por tamaño: se referencian con sus identificadores públicos en `anexos/A_repositorio/INPUTS_CONJUNTO_DATOS.md`.
...
- Los datos de curado por herramienta (DeepTMHMM, MEME, Pepstats, DeepLoc, FASTAs, consenso, GFF3 corregido) están en `anexos/B_curado_gff3_vs_exonerate/`.
- El árbol incluido es el de 282 hojas / 277 nodos (con la rama parcial `Fxa6Dg03790`), que es el que respalda las cifras citadas en §6.2.2 del TFG. Detalle en `anexos/I_soportes_filo/README.md`.
