...
Si las tres condiciones se cumplen en GFF3, se prefiere GFF3 (`PEP`). Si fallan en GFF3 pero se cumplen en Exonerate, se prefiere Exonerate (`EXO`). Si fallan en ambas, el gen queda como descarte (`MAL`, ver `annexes/E_descartes/`).
